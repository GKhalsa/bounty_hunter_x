...
function GameBoardScreenTextHelper(ctx, score, canvasWidth){
  this.ctx         = ctx;
  this.score       = score;
...
GameBoardScreenTextHelper.prototype.drawScore = function(){
...
GameBoardScreenTextHelper.prototype.gameOverScreen = function(){
  this.ctx.font = "20px 'Press Start 2P'";
  this.ctx.fillStyle = "#0095DD";
