...
MainGameLoop.prototype.loop = function(){
  ...
  if(this.gameBoard.startGame !== true){this.gameBoard.textHelpers.startScreen();}
  if(this.gameBoard.endGame === true){this.gameBoard.textHelpers.gameOverScreen(this.gameBoard.score);}
