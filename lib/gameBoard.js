...
GameBoard.prototype.renderEnemyPlanes = function(){
  ...
  if (this.checkEnemyPlaneLocations()){console.log('offf');} // or check that all planes are killed
...
// GameBoard.prototype.drawUserShipMovement = function(){
//   let userShipImages = new UserShipImages(this.ctx);
//
//   userShipImages.centerPlaneImage(this.shipX, this.shipY);
// };

GameBoard.prototype.setup = function() {
  // this.drawShip();
  // this.drawUserShipMovement();
  this.drawScore();
